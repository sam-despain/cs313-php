...
<html>
	<body>
		...
		<form class="fittedDiv" action="createFurniture.php" method="post">
			...
			<p class="fittedDiv" style="padding: 10px;">Furniture type<br>
			...
			<p class="fittedDiv" style="padding: 10px;">Finish<br>
			...
			<p class="fittedDiv" style="padding: 10px;">Collection<br>
