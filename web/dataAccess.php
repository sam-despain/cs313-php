...
<html>
	<body>
		...
		<form class="fittedDiv" action="createFurniture.php" method="post">
			...
			<p>Dimensions<br>
			<input width="36px" type="number" name="widthInput" placeholder="Width"><br>
			<input width="36px" type="number" name="heightInput" placeholder="Height"><br>
			<input width="36px" type="number" name="depthInput" placeholder="Depth"></p>
